...
Then use `npm run dev` to view the website locally
...
Por fim, execute `npm run dev` para ver o website localmente

Execute `test.py` para realizar os testes unitários
